...
export class TooltipInformation {
    ...
    localResultTooltip = "Aqui mostramos as informações dos locais encontrados, de acordo com os filtros selecionados e tags pedidas. Para cada local exibido, além das informações básicas, existem mais duas interações possíveis: salvar o local nos locais salvos do usuário, e consultar mais informações sobre um lugar."
}